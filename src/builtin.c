...
} builtin_list[] = {{1, "q", builtin_exit},	   {2, "cd", builtin_cd},
		    {2, "bg", builtin_bg},	   {2, "fg", builtin_fg},
		    {3, "pwd", builtin_pwd},	   {3, "set", builtin_set_env},
		    {4, "show", builtin_show_env}, {4, "calc", builtin_calc},
		    {5, "clear", builtin_clean},   {0, NULL, NULL}};
